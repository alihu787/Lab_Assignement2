...
public class Residential extends Property implements Serializable{
	...
	/*
	 * public Residential(String description,String location, double area, double
	 * sitevalue, double CIV, double CIR, double NAV, String valuationDate,
	 * RatePayer owner, String typeString, String architectureString) {
	 * super(description,location,area,sitevalue,CIV,CIR,NAV,valuationDate,owner);
	 * this.setPropertyType(typeString);
	 * this.setArchitecturalStyle(architectureString);
	 * setCapitalImprovedRate(CIV_RATE); setUpExtraServices(); }
	 */
	
	public Residential( String typeString, String architectureString)
	{
		super();
		this.setPropertyType(typeString);
		this.setArchitecturalStyle(architectureString);
