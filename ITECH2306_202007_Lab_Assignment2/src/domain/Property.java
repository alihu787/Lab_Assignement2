...
public abstract class Property implements Serializable{
	...
	/*
	 * public Property(String description,String location, double area, double
	 * sitevalue, double CIV, double CIR, double NAV, String valuationDate,
	 * RatePayer owner) { this.description = description; this.location = location;
	 * this.area = area; this.siteValue = sitevalue; this.capitalImprovedRate = CIR;
	 * this.capitalImprovedValue = CIV; this.netAnnualValue = NAV;
	 * this.valuationDate = valuationDate; this.owner = owner; }
	 */
	...
	public String toString() {
		return "Property [description=" + description + ", area=" + area + ", netAnnualValue=" + netAnnualValue + ",\nowner=" + owner + ",\ncapitalImprovedValue=" + capitalImprovedValue
